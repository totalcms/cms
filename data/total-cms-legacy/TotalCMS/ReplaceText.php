...
class ReplaceText
{
	...
	{
		$download = $this->root_offset."/rw_common/plugins/stacks/dynamics/totaldownload.php?type=datastore&slug=".$slug;
	...
	{
		$info = pathinfo($filename);
		$download = $this->root_offset."/rw_common/plugins/stacks/dynamics/totaldownload.php?type=file&slug=".$info['filename']."&ext=".$info['extension'];
		return str_replace($macro, $download, $buffer);
	}
