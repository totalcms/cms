...
use TotalCMS\Middleware\License\ProLicenseMiddleware;

final class ProLicenseMiddlewareTest extends TestCase
{
	private ProLicenseMiddleware $middleware;
	...
	{
		$this->middleware = new ProLicenseMiddleware();
