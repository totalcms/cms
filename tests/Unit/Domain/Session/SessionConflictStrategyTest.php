...
class SessionConflictStrategyTest extends TestCase
{
	...
	public function testReplaceStrategyBehavior(): void
	{
		...
		$result = $this->simulateReplaceStrategy();
	...
	private function simulateReplaceStrategy(): array
	{
	...
	private function simulateDataPreservation(bool|array|string|int|float|null $data): bool|string|int|float|array|null
	{
