...
describe('LicenseData', function () {
    test('creates from API response with valid license', function () {
        $response = [
            'valid' => true,
            'edition' => 'pro',
    ...
    test('creates from API response with trial', function () {
        $response = [
            'valid' => true,
            'edition' => 'trial',
    ...
    test('handles missing fields with defaults', function () {
        $response = [
            'valid' => false,
    ...
    test('validates cache properly', function () {
