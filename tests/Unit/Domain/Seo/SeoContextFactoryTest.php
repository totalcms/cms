...
final class SeoContextFactoryTest extends TestCase
{
	...
	public function testBuilderPageResolvesToThePageKind(): void
	{
		...
		$this->assertSame(['type' => '', 'title' => '', 'socialTitle' => '', 'description' => '', 'socialDescription' => '', 'image' => ''], $ctx->seoBlock);
	}
	...
	public function testBlogObjectGetsTheArticleDefaultBlock(): void
	{
		...
		$this->assertSame(['type' => 'blogposting', 'title' => '', 'socialTitle' => '', 'description' => '${summary}', 'socialDescription' => '', 'image' => 'image'], $ctx->seoBlock);
	...
	public function testFeedObjectDescribesItselfFromContent(): void
	{
		...
		$this->assertSame(['type' => 'blogposting', 'title' => '', 'socialTitle' => '', 'description' => '${content}', 'socialDescription' => '', 'image' => 'image'], $ctx->seoBlock);
	}
	...
	public function testExplicitCollectionSeoBlockOverridesTheDefault(): void
	{
		$this->collectionFetcher->method('fetchCollection')->willReturn(
			$this->blogCollection(['type' => 'website', 'title' => '${name}', 'description' => 'excerpt', 'socialDescription' => 'tagline', 'image' => 'cover']),
		);
		$this->urlBuilder->method('buildUrl')->willReturn('/blog/hello');

		$ctx = $this->factory->make(['id' => 'hello'], ['collection' => 'blog']);

		$this->assertSame(['type' => 'website', 'title' => '${name}', 'socialTitle' => '', 'description' => 'excerpt', 'socialDescription' => 'tagline', 'image' => 'cover'], $ctx->seoBlock);
	}
	...
	public function testPartialBlogBlockMergesOverTheArticleDefault(): void
	{
		...
		// Only `image` was mapped — the others keep the article default.
		$this->assertSame(['type' => 'blogposting', 'title' => '', 'socialTitle' => '', 'description' => '${summary}', 'socialDescription' => '', 'image' => 'cover'], $ctx->seoBlock);
	}
	...
	public function testMappedTitlePropertyMergesOverTheArticleDefault(): void
	{
		...
		// Only `title` was mapped — the others keep the article default.
		$this->assertSame(['type' => 'blogposting', 'title' => '${name}', 'socialTitle' => '', 'description' => '${summary}', 'socialDescription' => '', 'image' => 'image'], $ctx->seoBlock);
	}
	...
	public function testPartialBlockOnANonBlogCollectionLeavesTheOtherKeysEmpty(): void
	{
		...
		$this->assertSame(['type' => '', 'title' => '', 'socialTitle' => '', 'description' => 'intro', 'socialDescription' => '', 'image' => ''], $ctx->seoBlock);
	}
	...
	public function testAnArrayWithNoIdAndNoCollectionIsAnAdHocPage(): void
	{
		...
		$this->assertSame('${socialDescription}', $ctx->seoBlock['socialDescription']);
	}
