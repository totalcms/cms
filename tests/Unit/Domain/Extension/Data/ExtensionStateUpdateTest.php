...
describe('ExtensionState updateDisabled', function () {
	test('defaults to not update-disabled', function () {
		expect((new ExtensionState(enabled: true))->isUpdateDisabled())->toBeFalse();
	});

	test('updateDisabled round-trips through toArray/fromArray', function () {
	...
	test('clearUpdateDisabled removes the block', function () {
