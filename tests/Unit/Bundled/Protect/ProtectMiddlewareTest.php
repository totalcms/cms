...
final class ProtectMiddlewareTest extends TestCase
{
	...
	{
		$this->middleware = new ProtectMiddleware();
	...
	public function testValidCookiePassesThrough(): void
	{
		$passcode = '8675';
		$pageId   = 'preview';
		$hmac     = hash_hmac('sha256', $passcode, $pageId);
	...
	{
		$oldHmac = hash_hmac('sha256', '1111', 'preview');
	...
	{
		$middleware = new ProtectMiddleware(defaultPasscode: '5555');
	...
	{
		$middleware = new ProtectMiddleware(defaultPasscode: '1234', defaultPromptTitle: 'Site Preview');
