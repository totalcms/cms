 ...
 * It is inherited by all classes in the TotalCMS\Utils\Color\Colors namespace.
 */
abstract class Color implements \Stringable
{
	 ...
	 */
	public static function space(): ColorSpace
	{
