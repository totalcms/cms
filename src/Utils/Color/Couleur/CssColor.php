...
use       TotalCMS\Utils\Color\Couleur\exceptions\UnsupportedCssColor;
...
enum CssColor {
    ...
    /**
     * Returns a new instance of TotalCMS\Utils\Color\Couleur\colors\Css corresponding to the current CssColor.
     *
     * @param  Css|null     $fallback An instance of TotalCMS\Utils\Color\Couleur\colors\Css used as a fallback in case of error
    ...
    /**
     * Returns a new instance of TotalCMS\Utils\Color\Couleur\colors\HexRgb corresponding to the current CssColor.
     *
     * @param HexRgb|null  $fallback An instance of TotalCMS\Utils\Color\Couleur\colors\HexRgb used as a fallback in case of error
     * @param boolean|null $throw    If false no exception will be thrown, $fallback will be returned instead
     * 
     * @return HexRgb|null
     */
    ...
    /**
     * Returns a new instance of TotalCMS\Utils\Color\Couleur\colors\Rgb corresponding to the current CssColor.
     *
     * @param Rgb|null     $fallback An instance of TotalCMS\Utils\Color\Couleur\colors\Rgb used as a fallback in case of error
     * @param boolean|null $throw    If false no exception will be thrown, $fallback will be returned instead
     * 
     * @return Rgb|null
     */
