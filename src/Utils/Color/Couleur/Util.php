...
use       TotalCMS\Utils\Color\Couleur\Converters\OkLab;
...
use       TotalCMS\Utils\Color\Couleur\Exceptions\CallbackDoesNotExist;
use       TotalCMS\Utils\Color\Couleur\Exceptions\UnknownColorSpace;
use       TotalCMS\Utils\Color\Couleur\Exceptions\UnsupportedCoordinateModifier;
...
abstract class Util {
     ...
     * @param  boolean                               $hue   If true applies 360° wraparound for hue values
     *
     ...
     *
     * This fonction only works with color spaces handled by the TotalCMS\Utils\Color\Couleur\ColorSpace enum.
     *
