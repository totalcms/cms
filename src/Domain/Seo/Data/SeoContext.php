...
final readonly class SeoContext
{
	 ...
	 * @param array{type:string,title:string,socialTitle:string,description:string,socialDescription:string,image:string} $seoBlock Collection-level mapping: content type, title/social title templates, description, social description and image property names
