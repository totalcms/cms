        ...
        if (function_exists('getimageSize')) {
            ...
            if (function_exists('iptcparse')) {
                if (isset($info["APP13"])) {
                    ...
                    if (is_array($iptc)) {
                        $title     = isset($iptc['2#005']) ? htmlentities(implode(",", $iptc["2#005"])) : '';
                        $caption   = isset($iptc['2#120']) ? htmlentities(implode(",", $iptc["2#120"])) : '';
                        $copyright = isset($iptc['2#116']) ? htmlentities(implode(",", $iptc["2#116"])) : '';
                    }
                }
            } else {
