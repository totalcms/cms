...
For complete filtering documentation including boolean/string handling, multi-criteria, precedence, and PHP usage examples, see the [Index Filter Documentation](docs/apis/index-filter).
