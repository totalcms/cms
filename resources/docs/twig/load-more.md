...
If your layout already calls the [core asset helpers](docs/twig/overview), there is nothing more to add. Without them the button renders unstyled and clicking it fetches nothing, since htmx never loads.
