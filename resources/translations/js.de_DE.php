...
return [
	...
	'confirm.delete_folder'        => 'Sind Sie sicher, dass Sie diesen Ordner und seinen gesamten Inhalt löschen möchten? Dies kann nicht rückgängig gemacht werden. Geben Sie zur Bestätigung den Ordnernamen ein: "{name}"',
