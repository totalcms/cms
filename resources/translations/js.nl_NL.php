...
return [
	...
	'confirm.delete_folder'        => 'Weet u zeker dat u deze map en alle inhoud wilt verwijderen? Dit kan niet ongedaan worden gemaakt. Typ de mapnaam om te bevestigen: "{name}"',
